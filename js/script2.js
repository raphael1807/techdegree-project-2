...
function showPage(list, page) {
    ...
    let ulStudent = document.getElementsByClassName('student-list');
    ...
    for (let i = 0; i < list.length; i += 1) {
        ...
        if (i >= startIndex && i < endIndex) {
            ...
            divStudentDetails.class = "student-details";
...
function paginationButtons(list) {
    ...
    let ulLink = document.getElementsByClassName('link-list');
    ...
    for (let i = 0; i < numberOfPagination.length; i += 1) {
    ...
    ulLink.insertAdjacentHTML('beforeend', liPagination);

    // 3.6 Select the first pagination button and give it a class name of active.
    ulLink[0].firstChild.class = "active";
    ...
    ulLink.addEventListener('click', (event) => {
        ...
        // 3.8.4 Call the showPage function p=assing the list parameter and the page number to display as arguments.
