...
btn.innerHTML = "Fun DOM Manipulation"; // Insert text
btn.id = "main-heading";
...
div.id = "boat-container"; // Insert text
...
img.src = "img/boat.png"; // Insert text
img.alt = "Tugboat";
img.id = "boat-img";
div.appendChild(img); // Append <button> to <body>
...
var img = document.createElement("IMG"); // Create a <button> element
img.src = "img/mike.png"; // Insert text
img.alt = "Mike The Frog";
img.id = "mike";
img.class = "mike"
body.appendChild(img); // Append <button> to <body>